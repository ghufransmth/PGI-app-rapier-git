...
public class AdapterYear extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AdapterYear(Context c, RecyclerView mRecyclerView, List<DataProvince> myArray, DialogPlus dialogPlus, GadaiBPKB gadaiBPKB, String idSelect) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(c).inflate(R.layout.model_list_province, parent, false);
            return new AdapterYear.UserViewHolder(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(c).inflate(R.layout.progressbar, parent, false);
            return new AdapterYear.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdapterYear.UserViewHolder) {
            final DataProvince DataProvince = myArray.get(position);
            AdapterYear.UserViewHolder userViewHolder = (AdapterYear.UserViewHolder) holder;
