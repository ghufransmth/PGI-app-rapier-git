...
public class AdapterYear3 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AdapterYear3(Context c, RecyclerView mRecyclerView, List<DataProvince> myArray, DialogPlus dialogPlus, GadaiBPKB gadaiBPKB, String idSelect) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(c).inflate(R.layout.model_list_province, parent, false);
            return new AdapterYear3.UserViewHolder(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(c).inflate(R.layout.progressbar, parent, false);
            return new AdapterYear3.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdapterYear3.UserViewHolder) {
            final DataProvince DataProvince = myArray.get(position);
            AdapterYear3.UserViewHolder userViewHolder = (AdapterYear3.UserViewHolder) holder;
            ...
            userViewHolder.parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dialogPlus.dismiss();
                    gadaiBPKB.setYear(""+DataProvince.getid(),""+DataProvince.getname());
                }
            });
