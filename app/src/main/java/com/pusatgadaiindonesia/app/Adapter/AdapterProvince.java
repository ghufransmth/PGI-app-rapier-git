...
public class AdapterProvince extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    Signup signup;
    String idSelect;
    public AdapterProvince(Context c, RecyclerView mRecyclerView, List<DataProvince> myArray, DialogPlus dialogPlus, Signup signup, String idSelect) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(c).inflate(R.layout.model_list_province, parent, false);
            return new AdapterProvince.UserViewHolder(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(c).inflate(R.layout.progressbar, parent, false);
            return new AdapterProvince.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdapterProvince.UserViewHolder) {
            final DataProvince DataProvince = myArray.get(position);
            AdapterProvince.UserViewHolder userViewHolder = (AdapterProvince.UserViewHolder) holder;
            ...
            userViewHolder.parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dialogPlus.dismiss();
                    signup.setProvince(""+DataProvince.getid(),""+DataProvince.getname());
                }
            });
