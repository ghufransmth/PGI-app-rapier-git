...
import com.pusatgadaiindonesia.app.Interface.Auth.Signup;
...
public class AdapterCity extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    Signup signup;
    String idSelect;
    public AdapterCity(Context c, RecyclerView mRecyclerView, List<DataCitiesDetail> myArray, DialogPlus dialogPlus, Signup signup, String idSelect) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(c).inflate(R.layout.model_list_province, parent, false);
            return new AdapterCity.UserViewHolder(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(c).inflate(R.layout.progressbar, parent, false);
            return new AdapterCity.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdapterCity.UserViewHolder) {
            final DataCitiesDetail dataCitiesDetail = myArray.get(position);
            AdapterCity.UserViewHolder userViewHolder = (AdapterCity.UserViewHolder) holder;
            ...
            userViewHolder.parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dialogPlus.dismiss();
                    signup.setCity(""+dataCitiesDetail.getid(),""+dataCitiesDetail.getname());
                }
            });
