...
public class AdapterYear4 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AdapterYear4(Context c, RecyclerView mRecyclerView, List<DataProvince> myArray, DialogPlus dialogPlus, GadaiElektronik gadaiElektronik, String idSelect) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(c).inflate(R.layout.model_list_province, parent, false);
            return new AdapterYear4.UserViewHolder(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(c).inflate(R.layout.progressbar, parent, false);
            return new AdapterYear4.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdapterYear4.UserViewHolder) {
            final DataProvince DataProvince = myArray.get(position);
            AdapterYear4.UserViewHolder userViewHolder = (AdapterYear4.UserViewHolder) holder;
            ...
            userViewHolder.parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dialogPlus.dismiss();
                    gadaiElektronik.setYear(""+DataProvince.getid(),""+DataProvince.getname());
                }
            });
