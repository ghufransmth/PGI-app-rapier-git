...
public class AdapterMasterBPKB extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    String idSelect;
    String option;
    public AdapterMasterBPKB(Context c, RecyclerView mRecyclerView, List<DataMaster> myArray, DialogPlus dialogPlus, GadaiBPKB gadaiBPKB, String idSelect, String option) {
        this.mRecyclerView = mRecyclerView;
        this.myArray = myArray;
        this.c = c;
        this.dialogPlus = dialogPlus;
        this.gadaiBPKB = gadaiBPKB;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(c).inflate(R.layout.model_list_province, parent, false);
            return new AdapterMasterBPKB.UserViewHolder(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(c).inflate(R.layout.progressbar, parent, false);
            return new AdapterMasterBPKB.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdapterMasterBPKB.UserViewHolder) {
            final DataMaster DataMaster = myArray.get(position);
            AdapterMasterBPKB.UserViewHolder userViewHolder = (AdapterMasterBPKB.UserViewHolder) holder;
            ...
            userViewHolder.parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (option.equals("2"))
                    {
                        gadaiBPKB.setMerk(""+DataMaster.getid(),""+DataMaster.getname());
                    }
                    else
                    {
                        gadaiBPKB.setTipe(""+DataMaster.getid(),""+DataMaster.getname(), ""+DataMaster.getMaxLoanPrice());
                    }
                }
            });
