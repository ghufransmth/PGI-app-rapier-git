...
public class AdapterCityEditProfile extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private final int VIEW_TYPE_ITEM = 0;
    private final int VIEW_TYPE_LOADING = 1;
    List<DataCitiesDetail> myArray;
    ...
    String idSelect;
    public AdapterCityEditProfile(Context c, RecyclerView mRecyclerView, List<DataCitiesDetail> myArray, DialogPlus dialogPlus, EditProfile editProfile, String idSelect) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(c).inflate(R.layout.model_list_province, parent, false);
            return new AdapterCityEditProfile.UserViewHolder(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(c).inflate(R.layout.progressbar, parent, false);
            return new AdapterCityEditProfile.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdapterCityEditProfile.UserViewHolder) {
            final DataCitiesDetail dataCitiesDetail = myArray.get(position);
            AdapterCityEditProfile.UserViewHolder userViewHolder = (AdapterCityEditProfile.UserViewHolder) holder;

            userViewHolder.name.setText(""+dataCitiesDetail.getname());
            if (idSelect.equals(""+dataCitiesDetail.getid()))
            {
            ...
            userViewHolder.parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dialogPlus.dismiss();
                    editProfile.setCity(""+dataCitiesDetail.getid(),""+dataCitiesDetail.getname());
                }
            });
