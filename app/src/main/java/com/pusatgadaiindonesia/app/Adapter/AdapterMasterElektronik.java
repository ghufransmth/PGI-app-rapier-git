...
public class AdapterMasterElektronik extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    GadaiElektronik gadaiElektronik;
    String idSelect;
    String option;
    public AdapterMasterElektronik(Context c, RecyclerView mRecyclerView, List<DataMaster> myArray, DialogPlus dialogPlus, GadaiElektronik gadaiElektronik, String idSelect, String option) {
        this.mRecyclerView = mRecyclerView;
        this.myArray = myArray;
        this.c = c;
        this.dialogPlus = dialogPlus;
        this.gadaiElektronik = gadaiElektronik;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(c).inflate(R.layout.model_list_province, parent, false);
            return new AdapterMasterElektronik.UserViewHolder(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(c).inflate(R.layout.progressbar, parent, false);
            return new AdapterMasterElektronik.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdapterMasterElektronik.UserViewHolder) {
            final DataMaster DataMaster = myArray.get(position);
            AdapterMasterElektronik.UserViewHolder userViewHolder = (AdapterMasterElektronik.UserViewHolder) holder;
            ...
            userViewHolder.parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(option.equals("1"))
                    {
                        gadaiElektronik.setJenis(""+DataMaster.getid(),""+DataMaster.getname());
                    }
