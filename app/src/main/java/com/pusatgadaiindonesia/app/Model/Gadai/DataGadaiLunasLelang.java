...
public class DataGadaiLunasLelang {
    ...
    public DataGadaiLunasLelang(String id, String noFaktur, String tipe, String merk, String jenisBarang, String jenisPinjaman, String status,
