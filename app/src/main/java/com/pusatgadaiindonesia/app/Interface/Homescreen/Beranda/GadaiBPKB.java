...
import com.pusatgadaiindonesia.app.Adapter.AdapterMasterBPKB;
import com.pusatgadaiindonesia.app.Adapter.AdapterYear3;
...
public class GadaiBPKB extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gadai_bpkb);
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            ...
            case R.id.lanjut:
                ...
                {
                    Intent intent = new Intent(GadaiBPKB.this, GadaiBPKB2.class);
    ...
    public void showYear()
    {
        ...
        AdapterYear3 myAdapter;
        List<DataProvince> listAllData = new ArrayList<>();

        RecyclerView recyclerView = view.findViewById(R.id.rv);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        myAdapter = new AdapterYear3(this,recyclerView,listAllData, dialog, GadaiBPKB.this, selectedYearId);
    ...
    public void showMerk()
    {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.rv);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        myAdapterMerk = new AdapterMasterBPKB(this,recyclerView,listAllDataMerk, dialog, GadaiBPKB.this, selectedMerkId, "2");
    ...
    public void showTipe()
    {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.rv);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        myAdapterTipe = new AdapterMasterBPKB(this,recyclerView,listAllDataTipe, dialog, GadaiBPKB.this, selectedTipeId, "3");
