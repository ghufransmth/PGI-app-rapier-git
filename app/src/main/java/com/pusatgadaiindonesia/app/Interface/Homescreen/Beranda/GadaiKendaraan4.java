...
public class GadaiKendaraan4 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gadai_kendaraan4);
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            ...
            case R.id.jenis:
                Intent intent = new Intent(GadaiKendaraan4.this, GadaiDetail.class);
            ...
            case R.id.merk:
                ...
                {
                    Intent intent2 = new Intent(GadaiKendaraan4.this, GadaiDetail.class);
            ...
            case R.id.tipe:
                ...
                {
                    Intent intent3 = new Intent(GadaiKendaraan4.this, GadaiDetail.class);
            ...
            case R.id.warna:
                ...
                {
                    Intent intent4 = new Intent(GadaiKendaraan4.this, GadaiDetail.class);
            ...
            case R.id.tahun:
                ...
                {
                    Intent intent5 = new Intent(GadaiKendaraan4.this, GadaiDetail.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        {
            if(data.getStringExtra("val").equals("6")){
                textjenis.setText(""+data.getStringExtra("nama"));
                textMerk.setText("Merk Kendaraan");
    ...
    public void dialogSuccess(String message)
    {
        ...
        oke.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                finish();
                Intent intent = new Intent(GadaiKendaraan4.this, Homescreen.class);
