...
public class GadaiBPKB3 extends AppCompatActivity implements View.OnClickListener {
    ...
    String sendNopol="", sendKategori="", sendMerk="", sendTipe="",sendYear="", sendGrade="", sendAtasNamaId="", sendAtasNamaText="";
    String sendNama="", sendStnkNama="", sendStnkAlamat="", sendBpkbNo="", sendBpkbNama="", sendBpkbNoMesin="", sendBpkbNoRangka="", sendPajak="", sendSubTipe="", sendMaxLoan="";/*, getPercentage="";*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gadai_bpkp3);
        ...
        int myPercentage = 0;
        try {
            set = Integer.parseInt(sendMaxLoan);
            myPercentage = Integer.parseInt(getPercentage);
            set = set * myPercentage / 100;
            sendAmount = set;
        ...
        String text = formatRupiah.format((double)set);
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            ...
            case R.id.lokasi:
                Intent intent = new Intent(GadaiBPKB3.this, CabangTerdekatSelect.class);
    ...
    public void dialogSuccess(String message)
    {
        ...
        oke.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                finish();
                Intent intent = new Intent(GadaiBPKB3.this, Homescreen.class);
                startActivity(intent);
            }
        });
        dialog.show();
    ...
    public void sendData()
    {
        ...
        SendBpkb sendBpkb = new SendBpkb(""+sendNama,
                 ""+sendStnkNama, ""+sendStnkAlamat, ""+sendBpkbNo, ""+sendBpkbNama,
                ""+sendBpkbNoMesin, ""+sendBpkbNoRangka,""+creditDate, ""+sendAmount, ""+day,
                ""+idLocation, ""+sendPajak, ""+sendKategori, ""+sendMerk,""+sendTipe,""+sendNopol,""+sendYear,""+sendGrade,""+sendGrade,""+sendAtasNamaText,
                ""+sendStnkNama,  ""+idLocation, ""+sendSubTipe);
        APIService service = ApiClient.getClient().create(APIService.class);
        Call<ResponseNormal> userCall = service.gadaiBpkb(tokenBearer, sendBpkb);
